...
const NewConfiguration = (props: { location: { state: any } }) => {
  ...
  const onDownload = () => {
    axios({
      ...
      .then((response) => {
        ...
        // Cleanup the temporary link after the download is initiated
